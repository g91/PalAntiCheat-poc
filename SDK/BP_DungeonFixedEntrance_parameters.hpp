...
struct ABP_DungeonFixedEntrance_C_GetInteractWidget_Params
{
public:
	...
	class UWBP_DungeonInfo_FixedDungeon_C*       CallFunc_Create_ReturnValue;                       // 0x18(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
};

// 0xC0 (0xC0 - 0x0)
// Function BP_DungeonFixedEntrance.BP_DungeonFixedEntrance_C.GetDeadItemDropPoint
struct ABP_DungeonFixedEntrance_C_GetDeadItemDropPoint_Params
{
public:
...
struct ABP_DungeonFixedEntrance_C_GetWarpPoint_Params
{
public:
	struct FTransform                            ReturnValue;                                       // 0x0(0x60)(Parm, OutParm, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FTransform                            CallFunc_K2_GetComponentToWorld_ReturnValue;       // 0x60(0x60)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
