...
class UClass* UWBP_IngameCompass_dungeonPortal_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("WBP_IngameCompass_dungeonPortal_C");

	return Clss;
}


// WBP_IngameCompass_dungeonPortal_C WBP_IngameCompass_dungeonPortal.Default__WBP_IngameCompass_dungeonPortal_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UWBP_IngameCompass_dungeonPortal_C* UWBP_IngameCompass_dungeonPortal_C::GetDefaultObj()
{
	static class UWBP_IngameCompass_dungeonPortal_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UWBP_IngameCompass_dungeonPortal_C*>(UWBP_IngameCompass_dungeonPortal_C::StaticClass()->DefaultObject);
...
void UWBP_IngameCompass_dungeonPortal_C::SetupTexture(TSoftObjectPtr<class UTexture2D> SoftTexture)
{
	...
	Params::UWBP_IngameCompass_dungeonPortal_C_SetupTexture_Params Parms{};
...
void UWBP_IngameCompass_dungeonPortal_C::SetDistanceText(double Length, double CallFunc_Multiply_DoubleDouble_ReturnValue, int64 CallFunc_Conv_DoubleToInt64_ReturnValue, class FText CallFunc_Conv_Int64ToText_ReturnValue, const struct FFormatArgumentData& K2Node_MakeStruct_FormatArgumentData, TArray<struct FFormatArgumentData>& K2Node_MakeArray_Array, class FText CallFunc_Format_ReturnValue)
{
	static class UFunction* Func = nullptr;
	...
	Params::UWBP_IngameCompass_dungeonPortal_C_SetDistanceText_Params Parms{};
