...
public:
	...
	uint8                                        Pad_1E48[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1E52[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1E5A[0x2B1];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1E5B[0x6];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1E69[0x68];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
