...
public:
	...
	uint8                                        Pad_19B3[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_19B5[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_19BA[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_19BC[0x14];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
