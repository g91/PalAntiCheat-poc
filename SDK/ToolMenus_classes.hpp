...
public:
	...
	uint8                                        Pad_1CF4[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1D07[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1DAF[0x60];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1DB1[0x128];                                   // Fixing Size Of Struct [ Dumper-7 ]
